...
const SYSTEM_PROMPT = [
  ...
  "For industries, extract specific customer markets served by the provider, not generic IT capabilities. Prefer labels such as Banking & Financial Services, Healthcare & Life Sciences, Public Sector & Government, Retail & E-commerce, Manufacturing & Industrial, Telecommunications & Media, Energy & Utilities, Transportation & Logistics, or Software & Technology when supported.",
  "Do not use generic service terms like Cloud, DevOps, Consulting, Digital Transformation, Managed Services, or Software Development as industries unless no market-specific evidence exists.",
...
function buildUserPrompt(scrapedData, retryMessage = null) {
  ...
  const instructions = [
    ...
    "For industries, return specific customer markets served by the provider. Avoid repetitive generic labels such as Cloud, DevOps, Consulting, Managed Services, or Digital Transformation when a more specific market is supported.",
